                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="facebook-marketing/index.html">Facebook Marketing</a></li>
                                    ...
                                    <article class="box-100 noidung">
                                       ...
                                       <div class="col-lg-4 col-md-4 col-sm-12 col-12 right-border ">
                                        ...
                                        <div class="box-100 content-left mt-4-box">
                                            ...
                                            <form method="post" action="{{route('form_service_add',['id'=>$chitiet->id])}}" class="form_tuyendung contact-left pop_dv" name="frmRegister" id="frmRegister">
                                                @csrf
                                                <div class="step_2">
                                                    ...
                                                    <button type="submit" onclick="javascript:formRegisterDefault('frmRegister');" class="w-100 btn btn-primary translate btn_dv text-uppercase">Đăng ký ngay</button>
