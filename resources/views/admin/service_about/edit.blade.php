    ...
    <div class="col-md-12">
      <div class="card mb-4 p-4">
        ...
        <form action="" method="POST" role="form">
          @csrf
          <legend>Sửa Giới Thiệu </legend>
          
             <div class="form-group">
            <label for="">Nội dung phần đầu (header)</label>
            <textarea name="content_header" class="ckeditor form-control is-invalid" placeholder="nhập nội dung">{!!$service_about->content_header!!}</textarea>
              
          </div>
            <div class="form-group">
            <label for="">Nội dung phần cuối (footer)</label>
            <textarea name="content_footer" class="ckeditor form-control @if($errors->has('content'))is-invalid @endif" placeholder="nhập nội dung">{!!$service_about->content_footer!!}</textarea>
