 ...
 <div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Sửa blog</li>
    </ol>
  </div>
        ...
        <form action="" method="POST" role="form">
          ...
          <div class="form-group">
            ...
            <select name="cat_id" id="input" class="form-control" required="required">
              ...
              @foreach($cats as $c)
              <option value="{{$c->id}}" {{$blog->cat_id==$c->id ? 'selected' : ''}}>{{$c->name}}</option>
              @endforeach
            </select>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control  @if($errors->has('name'))is-invalid @endif" name="name" value ="{{$blog->name}}" placeholder="nhập tên blog" >
            @if($errors->has('name'))
            <div class="invalid-feedback">
                        {{$errors->first('name')}}
                      </div>
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control @if($errors->has('title'))is-invalid @endif" name="title" value ="{{$blog->title}}"  placeholder="nhập tiêu đề blog" >
              @if($errors->has('title'))
            <div class="invalid-feedback">
                        {{$errors->first('title')}}
                      </div>
           ...
           <div class="form-group">
            ...
            <textarea name="description" class="form-control" placeholder="nhập mô tả nội dung">{{$blog->description}}</textarea> 
          ...
          <style>
           ...
           <div class="form-group">
            ...
            <textarea  name="summary" class="ckeditor form-control" >{{$blog->summary}}</textarea>
            ...
            <textarea name="content" class="ckeditor form-control @if($errors->has('content'))is-invalid @endif" placeholder="nhập nội dung">{{$blog->content}}</textarea>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control @if($errors->has('image'))is-invalid @endif" value="{{url('uploads')}}/{{$blog->image}}" name="image" id="image" placeholder="Trống" readonly>
               @if($errors->has('image'))
            <div class="invalid-feedback">
                        {{$errors->first('image')}}
                      </div>
            ...
            <img src="{{url('uploads')}}/{{$blog->image}}" id="show-image" style="margin: 10px 0" class="img-fluid">
          </div>
              <div class="form-group">
