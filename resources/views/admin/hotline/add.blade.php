 ...
 <div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">hotline</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="./">Trang chủ</a></li>
      <li class="breadcrumb-item">Liên Hệ</li>
      <li class="breadcrumb-item active" aria-current="page">Thêm hotline</li>
    </ol>
  </div>
      ...
      <div class="card mb-4 p-4">
        ...
        <form action="" method="POST" role="form">
          ...
          <style>
            ...
            <input type="number" class="form-control  @if($errors->has('phone'))is-invalid @endif" name="phone"  placeholder="nhập số điện thoại" >
            @if($errors->has('phone'))
            <div class="invalid-feedback">
                        {{$errors->first('phone')}}
                      </div>
            ...
            <input type="text" class="form-control  @if($errors->has('email'))is-invalid @endif" name="email"  placeholder="nhập email" >
            @if($errors->has('email'))
            <div class="invalid-feedback">
                        {{$errors->first('email')}}
                      </div>
           ...
           <textarea name="address" class="ckeditor form-control @if($errors->has('address'))is-invalid @endif"></textarea>
            ...
            <input type="text" class="form-control  @if($errors->has('website'))is-invalid @endif" name="website"  placeholder="nhập tên" >
