      ...
      <div class="card mb-4 p-4">
        ...
        <form action="" method="POST" role="form">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control  @if($errors->has('name'))is-invalid @endif" name="name" value="{{$service->name}}" placeholder="nhập tên dịch vụ" >
            @if($errors->has('name'))
           ...
           <div class="form-group">
            <label for="">tiêu đề dịch vụ(*)</label>
            <input type="text" class="form-control @if($errors->has('title'))is-invalid @endif" name="title" value="{{$service->title}}" placeholder="nhập tiêu đề dịch vụ" >
              @if($errors->has('title'))
            <div class="invalid-feedback">
                        {{$errors->first('title')}}
                      </div>
           ...
           <div class="form-group">
            ...
            <textarea name="description" class="form-control" placeholder="nhập mô tả nội dung">{{$service->description}}</textarea> 
          ...
          <style>
           ...
           <div class="form-group">
            ...
            <textarea  name="summary" class="ckeditor form-control" >{{$service->summary}}</textarea>
            ...
            <textarea name="content" class="ckeditor form-control @if($errors->has('content'))is-invalid @endif" placeholder="nhập nội dung">{{$service->content}}</textarea>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control @if($errors->has('image'))is-invalid @endif" name="image" value="{{url('uploads')}}/{{$service->image}}" id="image" placeholder="Trống" readonly>
               @if($errors->has('image'))
            <div class="invalid-feedback">
                        {{$errors->first('image')}}
                      </div>
            ...
            <img src="{{url('uploads')}}/{{$service->image}}" id="show-image" style="margin: 10px 0" class="img-fluid">
          </div>
              <div class="form-group">
